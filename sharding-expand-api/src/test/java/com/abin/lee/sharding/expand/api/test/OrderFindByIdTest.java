 ...
 */
public class OrderFindByIdTest {

    private static final String httpURL = "http://localhost:8099/order/findById";
    ...
    public void testOrderFindById() {
        try {
            ...
            nvps.add(new BasicNameValuePair("id", 26137900842483712L + ""));
